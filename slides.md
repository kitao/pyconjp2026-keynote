...
<div class="g"><div class="gh"><span class="ic"><svg viewBox="0 0 64 64" fill="none" stroke="currentColor" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="32" cy="32" r="25.13"/>
  ...
  <path d="M12.1 19.43h39.79M12.1 44.57h39.79"/></svg></span><span class="tx">世界のシミュレーション <span class="en block">Simulating a world</span></span></div><div class="gi"><span>計算 <span class="en block">Math</span></span> <span>ルール <span class="en block">Rules</span></span> <span>想像 <span class="en block">Imagination</span></span></div></div>
...
<div class="flow">
<div class="fb"><div class="fh"><span class="sq c1"><img src="assets/icon/link.svg" alt=""></span><span class="ft-h">URLを開く<span class="en block">Open the URL</span></span></div><div class="ft"><span>ランチャーがURLからリポジトリとファイルを読み取る<span class="en block">The launcher reads the repository and file from the URL</span></span></div></div>
<div class="fa"></div>
...
<span class="ft run hi"><span class="ic"><svg viewBox="0 0 24 24" fill="currentColor" stroke="currentColor"><path d="M2.37 4.61l8.44 7.39-8.44 7.39V4.61zM12.92 4.61l8.44 7.39-8.44 7.39V4.61z"/></svg></span><span class="tx"><b>超早送り実行<i>Turbo run</i></b><em>100秒のプレイを4.6秒で<i>100 sec of play in 4.6 sec</i></em></span></span>
